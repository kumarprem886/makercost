...
document.getElementById('pdfBtn').addEventListener('click', () => {
  ...
  doc.text('MakerCost', 14, 14);
  doc.setFontSize(9);
  doc.setFont('helvetica', 'normal');
  doc.text('3D Print Price Quote', 14, 22);
  doc.text(new Date().toLocaleDateString('en-IN', { day:'2-digit', month:'short', year:'numeric' }), 196, 22, { align: 'right' });
  ...
  doc.setFontSize(8);
  doc.setFont('helvetica', 'normal');
  doc.text('Generated by MakerCost | kumarprem886.github.io/makercost', 105, 285, { align: 'center' });
